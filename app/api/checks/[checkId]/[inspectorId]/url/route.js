...
export async function GET(request) {
  ...
  const checkId = pathSegments[pathSegments.length - 3] // Получение checkId из URL
  const inspectorId = pathSegments[pathSegments.length - 2] // Получение inspectorId из URL
