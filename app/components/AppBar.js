  ...
  return (
    <header className="bg-ming-blue p-4 flex justify-start items-center">
      <Menu as="div" className="relative inline-block text-left mr-4">
        <MenuButton className="inline-flex items-center justify-center gap-x-1.5 rounded-md bg-gray-200 px-3 py-1 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
        ...
        <MenuItems className="absolute mt-2 w-56 p-2 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          ...
          <MenuItem as="div">
            <div>
              <div className="flex items-center py-1 text-center  mt-2">
                <svg
          ...
          {user ? (
            <MenuItem as="div">
              ...
              >
                <p className="text-gray-700 block px-4 py-2 text-sm">{t('signOut')}</p>
              </div>
            </MenuItem>
          ) : (
            <MenuItem as="div">
