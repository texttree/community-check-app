...
const CheckInspectorDetail = ({ lng }) => {
  ...
  const { checkId, chapterNumber, inspectorId } = useParams()
      ...
      <div className="overflow-hidden rounded-lg">
        ...
        <div className="bg-inherit md:bg-white pb-32 md:pb-0">
          ...
          {!isInspectorDeletedLoading && isInspectorDeleted && (
            <p className="p-4 text-lg text-red-500">{t('inspectorDeleted')}</p>
          )}
          {!isLoading && material?.content && !isInspectorDeleted && info && (
            <div>
                        ...
                        >
                          <div className="flex flex-row items-center gap-2 py-2">
                            ...
                            <button
                              ...
                              className="p-2 text-neutral-700 hover:text-raisin-black focus:outline-none notification-button"
                              data-count={
                                showNoteInputs[verse.verse]
                                  ? null
                                  : notes[verse.verse]?.length
                              }
                            >
                              {showNoteInputs[verse.verse] ? (
                                <svg
